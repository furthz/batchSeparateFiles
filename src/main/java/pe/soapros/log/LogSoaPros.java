...
public class LogSoaPros extends Logger{
	 ...
	 */
	public static final String PREFIX_LOG_PB = "Batch process - ";
	
	/**
	 * instance.
	 */
	private static LogSoaPros instance;
	 ...
	 * 
	 */
	protected LogSoaPros(final String name) {
		super(name);
	 ...
	 * 
	 */
	public static LogSoaPros getInstance(final String name) {
		if (instance == null) {
			instance = new LogSoaPros(name);
		}
	 ...
	 * 
	 */
	public static LogSoaPros getInstance(final Class clazz) {
		if (instance == null) {
			instance = new LogSoaPros(clazz.getName());
		}
